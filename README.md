...
[![Go Report Card](https://goreportcard.com/badge/github.com/bleggett/policy?)](https://goreportcard.com/report/github.com/bleggett/policy)
[![ci](https://github.com/bleggett/policy/actions/workflows/ci.yaml/badge.svg)](https://github.com/bleggett/policy/actions/workflows/ci.yaml)
...
[![CodeQL](https://github.com/bleggett/policy/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/bleggett/policy/actions/workflows/codeql-analysis.yml)
---
...
* Binaries for Linux, Windows and Mac are available as tarballs in the [release](https://github.com/bleggett/policy/releases) page.
...
* Via a GO install
  ...
  ```shell
  go install github.com/bleggett/policy/cmd/policy@latest
  ```
